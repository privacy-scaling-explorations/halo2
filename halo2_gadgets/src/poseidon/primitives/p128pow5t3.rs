...
impl Spec<Fr, 3, 2> for P128Pow5T3 {
    fn full_rounds() -> usize {
        8
    }
...
mod tests {
    ...
    fn verify_constants() {
        ...
        verify_constants_helper(fr::ROUND_CONSTANTS, fr::MDS, fr::MDS_INV);
    }
    ...
    fn test_against_reference() {
...

        {
            ...
            let expected_output = [
                Fr::from_raw([
                    0x62db_a7cd_e832_1155,
                    0x43ab_db38_1d28_b59e,
                    0xaa02_3b17_aa23_a8bd,
                    0x1c1e_457a_6ef2_8389,
                ]),
                Fr::from_raw([
                    0x1846_2d4e_fc90_7340,
                    0xf27e_7fc4_ef70_76bd,
                    0x3fb1_2b28_cb99_bc88,
                    0x01d2_3eab_cf87_3cf7,
                ]),
                Fr::from_raw([
                    0x7bee_6a76_408b_5f87,
                    0x323a_dad9_7de4_e6f5,
                    0x989f_97aa_8391_baec,
                    0x179e_2b28_b7cf_fb8b,
                ]),
            ];

            permute::<Fr, P128Pow5T3Gen<Fr, 0>, 3, 2>(&mut input, &fr::MDS, &fr::ROUND_CONSTANTS);
            assert_eq!(input, expected_output);
        }
    }
    ...
    fn permute_test_vectors() {
...

        {
            ...
            for tv in crate::poseidon::primitives::test_vectors::fr::permute() {
                let mut state = [
                    Fr::from_repr(tv.initial_state[0]).unwrap(),
                    Fr::from_repr(tv.initial_state[1]).unwrap(),
                    Fr::from_repr(tv.initial_state[2]).unwrap(),
                ];

                permute::<Fr, super::P128Pow5T3, 3, 2>(&mut state, &mds, &round_constants);
    ...
    fn hash_test_vectors() {
        ...
        for tv in crate::poseidon::primitives::test_vectors::fr::hash() {
            let message = [
                Fr::from_repr(tv.input[0]).unwrap(),
                Fr::from_repr(tv.input[1]).unwrap(),
            ];

...
fn plonk_api() {
    ...
    let much_too_small_params = Setup::<Bn256>::new(1, &mut rng);
    assert_matches!(
    ...
    let slightly_too_small_params = Setup::<Bn256>::new(K - 1, &mut rng);
    assert_matches!(
    ...
    for _ in 0..10 {
        ...
        // // assert_eq!(
        // //     proof.len(),
        // //     halo2::dev::CircuitCost::<bn256::G1, MyCircuit<_>>::measure(K as usize, &circuit)
        // //         .proof_size(2)
        // //         .into(),
        // // );
